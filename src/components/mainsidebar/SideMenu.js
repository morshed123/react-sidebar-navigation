...
import logo from "../../assets/logo/logoMorshed3_prev_ui.png";
...
export const menuItems = [
  ...
  },
  {
    ...
    iconClassName: "bi bi-speedometer2",
    subMenus: [
      { name: "Courses", to: "/content-3/courses" },
      { name: "Videos", to: "/content-3/videos" },
    ],
  },
    ...
    <div className={`side-menu ${inactive ? "inactive" : ""}`}>
      ...
      <div className="side-menu-footer">
        ...
        <div className="user-info">
          <h5>Md Morshed Hossain</h5>
          <p>mdmorshedhossain38@gmail.com</p>
        </div>
      </div>
    </div>
  );
